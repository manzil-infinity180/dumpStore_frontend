...
export default function Component() {
  ...
  const features = [
    {
      tag: "Cloud-Powered Storage",
      outline:
        "Store unlimited bookmarks in the cloud without impacting browser performance",
    },
    {
      tag: "Universal Integration",
      outline:
        "Import from Chrome, Twitter, Reddit, and LinkedIn with one click",
    },
    {
      tag: "AI Chat Assistant",
      outline:
        "Chat with your bookmarks using natural language to find exactly what you need",
    },
  ...
  const reviews = [
    {
      name: "John Doe",
      rating: 5,
      text: "Dumpstore has revolutionized how I handle waste disposal!",
    },
    {
      name: "Jane Smith",
      rating: 4,
      text: "Great service, but could use more dumpsters in rural areas.",
    },
    {
      name: "Mike Johnson",
      rating: 5,
      text: "Saves me time and money. Highly recommended!",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 flex flex-col">
      <div
        className="absolute inset-0 bg-opacity-50 bg-gray-100"
        style={{
          ...
          <nav className="flex justify-between items-center max-w-6xl mx-auto w-full">
            ...
            <div>
              ...
              <button
                ...
                className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 ml-4"
              >
                Sign Up
              </button>
            </div>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 text-center flex-grow flex flex-col justify-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
                Your Bookmarks Just Got Smarter
              </h1>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
                  ...
                  <p className="text-4xl font-bold mb-6">
                    $35.99<span className="text-lg font-normal">/year</span>
                  </p>
                  <button
                    className={`w-full py-2 px-4 rounded-lg font-semibold ${
                      selectedPlan === "yearly"
        ...
        <footer className="bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-600 mb-4 md:mb-0">
              &copy; 2023 Dumpstore. All rights reserved.
            </div>
